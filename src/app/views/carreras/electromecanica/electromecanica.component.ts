...
@Component({
  selector: 'app-electromecanica',
  templateUrl: 'electromecanica.component.html',
})
export class ElectromecanicaComponent implements OnInit {
  ...
  onSave(): void {
    ...
    if (this.materiaForm.valid) {
      ...
      this.router.navigate(['carreras/electromecanica']);
